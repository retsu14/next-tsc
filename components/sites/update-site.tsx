...
import { useUpdatedBySiteMutation } from "@/app/services/sites/sites-slice";
...
const UpdateSite: React.FC = () => {
  ...
  const [updatedBySite, { isLoading }] = useUpdatedBySiteMutation();
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await updatedBySite(formData).then((res) => {
        if (res.data) {
          toast({
